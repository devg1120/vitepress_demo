...
export default defineConfig({
  ...
  themeConfig: {
    ...
    footer: { // [!code focus]
      ...
      copyright: 'Copyright © 2019-2023present devg1120', // [!code focus]
    }, // [!code focus]
  },
...
export default defineConfig({
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: 'Copyright © 2023 GSDOC：<a href="https://beian.miit.gov.cn/" target="_blank">GSDOC-****</a>', // [!code focus]
    },
  },
